...
/*
 * This package contains tests for the classes that model individual fairness.
 */
...
case class IndividualFairnessPipelineSpec ()
  extends
    AnyFunSuite
{
  ...
  lazy val ex = IndividualFairnessScenarioExample .mk

  lazy val individual_fairness_pipeline = IndividualFairnessPipeline .mk (ex .relevant_attribute)
...
trait IndividualFairnessScenarioExample
{
  ...
  lazy val relevant_attribute_set : Set [Agent] =
    Set [Agent] (
      agent0 , agent1 , agent2
    )

  def relevant_attribute (agent : Agent) : Boolean =
    relevant_attribute_set .contains (agent)
  ...
  lazy val outcome1 : Outcome =
    Outcome .mk (
      Seq [Assignment] (
        ...
        Assignment .mk (agent2) (resource50) ,
        Assignment .mk (agent3) (resource20) ,
        Assignment .mk (agent4) (resource20) ,
        Assignment .mk (agent5) (resource20)
      )
  ...
  lazy val outcome2 : Outcome =
    Outcome .mk (
      Seq [Assignment] (
        ...
        Assignment .mk (agent4) (resource50) ,
...
case class IndividualFairnessScenarioExample_ () extends IndividualFairnessScenarioExample

object IndividualFairnessScenarioExample {
  def mk : IndividualFairnessScenarioExample =
    IndividualFairnessScenarioExample_ ()
}
